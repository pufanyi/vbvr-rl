...
FASTVIDEO_REPO = Path(os.environ.get("WAN_TRAINER_FASTVIDEO_REPO", REPO_ROOT / "third_party/lmms-eval"))
VLLM_REPO = Path(os.environ.get("WAN_TRAINER_VLLM_REPO", REPO_ROOT / "third_party/lmms-eval-vllm"))
