...
# supported; the default remains 384.
...
set -q WIDTH[1]
or set -lx WIDTH 384
set -l native_resolution "$HEIGHT"x"$WIDTH"
...
set -l model_launcher
switch $native_resolution
    case 384x384
        set model_launcher $script_dir/../vbvr_pro_5b_diffsynth_step35500_unipc_50steps_384x384_81f_16fps_main_v2.fish
    case 512x512
        set model_launcher $script_dir/../vbvr_pro_5b_diffsynth_step35500_unipc_50steps_512x512_81f_16fps_main_v2.fish
    case '*'
        _fail "initial UniPC wrapper supports only 384x384 or 512x512, got $native_resolution"
end
fish $model_launcher $argv
