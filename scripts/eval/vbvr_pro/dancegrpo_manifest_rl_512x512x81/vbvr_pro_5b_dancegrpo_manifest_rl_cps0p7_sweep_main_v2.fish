...
# Evaluate every complete checkpoint from the production native-512 manifest-RL
...
or set -lx CONVERTED_PREFIX dancegrpo_vbvr_pro_5b_512x512x81_rule_cps0p7_from_diffsynth_step35500_bs32_lr_5e-6_manifest_rl_evalkit_e140038f
set -q HEIGHT[1]
...
or set -lx EVAL_LOG_DIR storage/eval_logs/vbvr_pro_main_v2_512x512x81_manifest_rl_e140_lr5e6_cps0p7_evalkit_4cc7d028

set -l script_dir (dirname (status filename))
fish $script_dir/../dancegrpo_manifest_rl_384x384x81/vbvr_pro_5b_dancegrpo_manifest_rl_cps0p7_sweep_main_v2.fish $argv
exit $status
