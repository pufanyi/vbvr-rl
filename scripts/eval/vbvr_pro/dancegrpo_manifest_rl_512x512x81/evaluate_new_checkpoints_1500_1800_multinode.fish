...
# Eight-machine evaluation for the immutable 2026-08-08 checkpoint extension:
#   checkpoint-1500, 1600, 1700, and 1800
#
...
# Existing baseline/checkpoint-100..1400 cells are intentionally excluded.
...
or set -g NEW_CHECKPOINT_STEPS 1500 1600 1700 1800
set -l steps
