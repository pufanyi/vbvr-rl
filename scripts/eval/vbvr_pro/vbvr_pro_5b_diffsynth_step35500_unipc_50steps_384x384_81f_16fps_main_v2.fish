...
# Controlled intermediate-resolution comparison for the preconverted
# DiffSynth TI2V-5B step-35500 model. Keep the 81-frame/16-FPS/50-step UniPC
# ODE protocol fixed, generate natively at 384x384, and resize every frame
# without crop to the 1024x1024 scorer canvas.
